...
(function(window, document, undefined)
{
    ...
    var wysiwyg = function( element, options )
    {
        var toolbar = options.toolbar,
            ...
            node_textarea = node_container != null ? node_container.querySelector('textarea') : null,
            commands, hotkeys = {},
        ...
        var node_contenteditable = node_container != null ? node_container.querySelector('[contenteditable=true]') : null;
        if( ! node_contenteditable )
        {
            ...
            node_contenteditable.setAttribute( 'style', 'height: 150px;' )
            var placeholder = node_textarea != null ? node_textarea.placeholder : "";
            if( placeholder )
